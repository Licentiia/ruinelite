...
public class ProjectileDetectorQueueOverlay extends OverlayPanel
{
	...
	@Inject
	public ProjectileDetectorQueueOverlay(
			Client client,
			ProjectileDetectorPlugin plugin,
			ProjectileDetectorConfig config,
