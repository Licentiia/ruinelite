...
public interface ProjectileDetectorConfig extends Config
{
	...
	default boolean enableZulrahPreset()
	{
		return true;
	}
	...
	default boolean onlyIfTargetingLocal()
	{
		return true;
	}
	...
	default boolean showTickCountdown()
	{
		return true;
	}
